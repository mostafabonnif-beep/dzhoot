...
- **EPG**: تغطية **27.8% بمعرّف / 19.9% تحلّل لبرامج حيّة** (3,316/16,691 — محسّنة 2026-08-30 جولة 6) + **268k برنامج**. المصادر الفعّالة: 8 ملفات epgshare01 في `EPG_EXTRA_SOURCES` (TR1/BEIN1/ALJAZEERA1/AE1/EG1/FR1/UK1/DE1) — آخر تحديث 0 فشل. iptv-epg.org يعمل جزئيًا (15 دولة ميتة 404 بينها dz/qa/ma/tn). السقف المتبقي بنيوي: OSN/Shahid/STC بلا أدلة عمومية — رفع التغطية فوق هذا يتطلب مصدرًا مرخّصًا مدفوعًا.
