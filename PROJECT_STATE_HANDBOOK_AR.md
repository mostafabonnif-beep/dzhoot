...
1. **وسم dead قديم على قنوات directPlayback**: قنوات NEO فُحصت قديمًا من الخادم (فشلت — 456)، وسمّت نفسها ميتة، ثم أُفلتت من الفحص بعد تفعيل directPlayback دون تصحيح الوسم.
