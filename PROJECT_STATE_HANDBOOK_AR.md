...
- **GitHub → VPS**: إصلاح حالة القنوات + حدود الذاكرة + الدليل — نُشرت على الإنتاج وتم التحقق منها بالـ checksums.
...
### التشخيص — سبب "16,635 قناة معطلة"
1. **وسم dead قديم على قنوات directPlayback**: قنوات Upstream فُحصت قديمًا من الخادم (فشلت — 456)، وسمّت نفسها ميتة، ثم أُفلتت من الفحص بعد تفعيل directPlayback دون تصحيح الوسم.
