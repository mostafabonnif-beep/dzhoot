...
- **المراحل المتبقية**: اختبار فعلي على جهاز TV/Emulator، وتجربة VOD/Series الكاملة على مصدر فعلي (النسخ الاحتياطي عن بُعد مُفعَّل، وAPK موقّع صدر في v1.3.3 بتاريخ 2026-09-17).
...
- [x] إخراج APK Debug ثم Release موقّع (v1.3.3، 2026-09-17 — أُصدر وتم التحقّق من التوقيع والبصمة ونقطة التحديث).
