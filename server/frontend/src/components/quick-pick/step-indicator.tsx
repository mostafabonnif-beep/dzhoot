...
const STEP_KEYS = [
  'quickPick.stepSources',
  'quickPick.stepCountry',
  'quickPick.stepLanguage',
  'quickPick.stepCategory',
  'quickPick.stepChannels',
  'quickPick.stepConfirm',
] as const;
          ...
          <div key={i} className="flex items-center flex-1 last:flex-none">
            <div className="flex flex-col items-center gap-0.5 sm:gap-1">
              <button
                ...
                aria-label={t('quickPick.stepLabel').replace('{n}', String(i + 1)).replace('{label}', label)}
