...
object CategoryLocalizer {
    ...
    private val GENRE_RULES = listOf(
        listOf("KIDS", "CHILD", "CARTOON", "أطفال", "اطفال") to ("أطفال" to "kids"),
        ...
        listOf("SERIES", "مسلسلات") to ("مسلسلات" to "series"),
        listOf("MUSIC", "موسيقى") to ("موسيقى" to "music"),
        listOf("DOCUMENT", "وثائقي") to ("وثائقي" to "documentary"),
        listOf("RELIG", "ISLAM", "QURAN", "دينية", "ديني", "إسلامية") to ("دينية" to "religious"),
        listOf("GENERAL", "عامة") to ("عامة" to "general"),
        listOf("ENTERTAIN", "ترفيه") to ("ترفيه" to "entertainment"),
