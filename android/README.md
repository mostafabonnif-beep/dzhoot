...
[![Release](https://img.shields.io/github/v/release/mostafabonnif-beep/dzhoot)](https://github.com/mostafabonnif-beep/dzhoot/releases/latest)
[![Build](https://github.com/mostafabonnif-beep/dzhoot/actions/workflows/ci.yml/badge.svg)](https://github.com/mostafabonnif-beep/dzhoot/actions/workflows/ci.yml)
[![Platform](https://img.shields.io/badge/platform-Fire%20TV%20%7C%20Android%20TV-orange)](https://github.com/mostafabonnif-beep/dzhoot)
[![License](https://img.shields.io/github/license/mostafabonnif-beep/dzhoot)](LICENSE)
[![Min SDK](https://img.shields.io/badge/min%20SDK-28%20(Android%209)-green)](https://github.com/mostafabonnif-beep/dzhoot)
...
Works standalone with any M3U source, or pairs with [DZ HOOF Server](https://github.com/mostafabonnif-beep/dzhoot) for full channel management, EPG, and OTA updates.

---

## Preview

<img src="/preview/preview1.jpg" alt="DZ HOOF — الشاشة الرئيسية" width="400">
<img src="/preview/preview2.jpg" alt="DZ HOOF — دليل البرامج EPG" width="400">
...
- **Server Sync** — Channel lists, favorites, and health status synced from [DZ HOOF Server](https://github.com/mostafabonnif-beep/dzhoot)
...
Get the latest APK from [GitHub Releases](https://github.com/mostafabonnif-beep/dzhoot/releases/latest).
...
See the [TV Pairing System docs](https://github.com/mostafabonnif-beep/dzhoot/blob/main/server/docs/workflow/TV_PAIRING_SYSTEM.md) for the full pairing flow.
...
This app is designed to pair with **[DZ HOOF Server](https://github.com/mostafabonnif-beep/dzhoot)** — a self-hosted Node.js/Docker server for managing channels, users, EPG, and devices from an admin panel.
